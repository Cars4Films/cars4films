    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-75 backdrop-blur-sm shadow-lg">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        >
          ...
          />
        </a>{" "}        <div className="hidden md:flex space-x-8 items-center animate-fade-in-up">
      ...
      {mobileMenuVisible && (
        <div className="md:hidden bg-gray-900 animate-fade-in-down">          <a
            href="#flota"
          ...
          >
            {t('navbar.contacto')}
          </a>          <div className="relative px-4 py-3">
            <button
